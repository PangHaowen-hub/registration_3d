...
def main():
    batch_size = 1
    fixed_path = '/disk1/panghaowen/TransMorph_Transformer_for_Medical_Image_Registration/data/cect_a_preprocess'
    moving_path = r'/disk1/panghaowen/TransMorph_Transformer_for_Medical_Image_Registration/data/ncct_preprocess'
    weights = [1, 0.02]
    ...
    train_set = datasets.MyDataset(fixed_path=fixed_path, moving_path=moving_path)
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        }, save_dir='experiments/' + save_dir, filename='%04d.pth.tar' % epoch)
