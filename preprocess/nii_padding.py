...
def pad(img_path, save_path):
    ...
    pad_transform = tio.transforms.CropOrPad((256, 256, 256), padding_mode=-1024)  # TODO:修改Padding值
...
if __name__ == '__main__':
    img_path = r'G:\CT2CECT\registration\data\cect_v_resample'
    save_path = r'G:\CT2CECT\registration\data\cect_v_preprocess'
